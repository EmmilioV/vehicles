...
namespace Vehicles.API.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckUserAsync("1010", "Luis", "Salazar", "luis@yopmail.com", "3059468774", "CalleX",UserType.Admin);
            await CheckUserAsync("2020", "Pablo", "Villa", "Pablo@yopmail.com", "3059468774", "CalleX", UserType.User);
            await CheckUserAsync("3030", "Ladys", "Bedoya", "Ledys@yopmail.com", "3059468774", "CalleX", UserType.User);
        }
